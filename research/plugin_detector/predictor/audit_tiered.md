...
## Totals
- Paths scanned: 59401
- Paths resolved: 59117
- Paths NOT resolved (broken refs): 284
...
Total distinct broken records: **191**

| tier | impact | distinct records |
|---|---|---:|
| **Tier 1** | MODL broken — invisible when worn / shown | 160 |
| **Tier 2** | only MOD2 broken — invisible when dropped/displayed | 7 |
| **Tier 2b** | only MOD3/MOD4 broken — invisible for female biped | 2 |
| **Tier 3** | only ICON broken — inventory icon missing | 22 |

**Tier-1 are the user-impactful bugs.** Tier-2 and Tier-3 are visible less often — Tier-2 only when items lie on the ground or display in vendor menus, Tier-3 only as a missing icon in the inventory panel.

### Tier breakdown by winning plugin

| plugin | total | T1 | T2 | T2b | T3 |
|---|---:|---:|---:|---:|---:|
| OOO Enhanced.esp | 64 | 50 | 0 | 0 | 14 |
| Oblivion.esm | 61 | 61 | 0 | 0 | 0 |
| Maskar's Oblivion Overhaul.esp | 29 | 24 | 5 | 0 | 0 |
| DLCFrostcragReborn.esp | 16 | 14 | 0 | 1 | 1 |
| Bashed Patch, 0.esp | 6 | 3 | 1 | 1 | 1 |
| OOOShiveringIsles.esp | 5 | 1 | 1 | 0 | 3 |
| Oscuro's_Oblivion_Overhaul.esm | 4 | 1 | 0 | 0 | 3 |
| Cobl Main.esm | 2 | 2 | 0 | 0 | 0 |
| DLCFrostcrag.esp | 2 | 2 | 0 | 0 | 0 |
| DLCBattlehornCastle.esp | 1 | 1 | 0 | 0 | 0 |
| Knights.esp | 1 | 1 | 0 | 0 | 0 |

## Full table

| mod | verdict | exclusive | substituted | shadowed | total files |
|---|---|---:|---:|---:|---:|
| OOO Enhanced - Resources | NEEDED (exclusive refs) | 8374 | 324 | 1671 | 14619 |
| Useful Meshes Collection | NEEDED (exclusive refs) | 1551 | 3 | 0 | 11257 |
...
| 1_Clickable Magic Gate | NEEDED (exclusive refs) | 5 | 0 | 0 | 4 |
...
| Inactive Window Scroll Fix | NOT REFERENCED by record-scan | 0 | 0 | 0 | 2 |
...
## Substitution suspects (57 content-hash groups)
...
### hash `ad1e7d3bc83b...` — 4 paths, 3 parent dirs, 133 record refs
...
### hash `58d35c15b6be...` — 2 paths, 1 parent dirs, 3 record refs

- `meshes/moo/armor/backpack/backpack.nif`
- `meshes/moo/armor/backpack/backpack3.nif`

### hash `feff9f701b5c...` — 2 paths, 2 parent dirs, 2 record refs

- `meshes/dungeons/jgayleid/jgaltorch001.nif`
- `meshes/lights/jgaltorch001.nif`
...
## Broken refs (284 paths NOT resolved by VFS)
